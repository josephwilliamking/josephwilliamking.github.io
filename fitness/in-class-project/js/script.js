! function(t) {
    ...
    var n = / \d+:(\d+):/,
        r = function(t, e, r) {
            ...
            if (i) {
                ...
                for (o.push(s > 3 ? "(...)" : "(start)"), a = c; a <= l; a++) o.push(("000" + (a + 1)).slice(-4) + "\t" + u[a].replace("\r", "").trim() + (a === s ? "  â›”" : ""));
    ...
    var r, i;
    (function() { /*! VelocityJS.org (1.4.1). (C) 2014 Julian Shapiro. MIT @license: en.wikipedia.org/wiki/MIT_License */
            ...
            if (!t.jQuery) {
                ...
                n.isWindow = function(t) {
                    ...
                    if (r) {
                        ...
                        for (o in t)
                            if (t.hasOwnProperty(o) && (i = n.call(t[o], o, t[o]), i === !1)) break; return t
